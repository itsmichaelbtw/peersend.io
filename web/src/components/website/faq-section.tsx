...
export function FaqSection(): React.ReactNode {
  return (
    <section className="max-w-[1200px] mx-auto border-x border-b border-gray-200 bg-gray-900 text-white">
        ...
        <div className="space-y-12">
          {FAQ_ITEMS.map((item) => (
            <div key={item.question}>
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-2xl">{item.answer}</p>
            </div>
          ))}
        </div>
      </div>
